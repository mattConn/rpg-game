/**
 * A glyph grid overlaid on each room. It is a pure rendering/data layer: cells
 * hold a glyph or nothing, and the player moves in pixels straight through them
 * (no collision here). An empty room draws nothing extra.
 */

import { CELL_SIZE, GRID_COLS, GRID_ROWS, type RoomCoord } from "../shared/constants.js";
